...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $nombreLibro = 'ReyesCaidos.txt'; // Nombre del archivo a descargar

        // Generar el archivo .txt
        $fileContent = "Nombre del Libro: Reyes Caidos\n";
...
<body>
    ...
    <div class="product-container">
        <h1>Reyes Caidos</h1>
        <img src="https://marketplace.canva.com/EAFjNCKkDPI/1/0/1003w/canva-portada-de-libro-de-fantas%C3%ADa-dram%C3%A1tico-verde-Ct1fLal3ekY.jpg" alt="Imagen del Producto">
