...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $nombreLibro = 'La Vida dentro de tu Cabesa.txt'; // Nombre del archivo a descargar

        // Generar el archivo .txt
        $fileContent = "Nombre del Libro: La Vida dentro de tu Cabesa\n";
...
<body>
    ...
    <div class="product-container">
        <h1>La Vida dentro de tu Cabesa</h1>
        <img src="https://marketplace.canva.com/EAE8SCCNlvo/1/0/1003w/canva-verde-y-rosa-ciencia-ficci%C3%B3n-portada-de-libro-SSKxUZUBOJg.jpg" alt="Imagen del Producto">
