...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $nombreLibro = 'Cada Historia Cuenta.txt'; // Nombre del archivo a descargar

        // Generar el archivo .txt
        $fileContent = "Nombre del Libro: Cada Historia Cuenta\n";
...
<body>
    ...
    <div class="product-container">
        <h1>Cada Historia Cuenta</h1>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkfINPOXpitTf5KiQMTGS4HdKBlnPkF_MSEw&s" alt="Imagen del Producto">
