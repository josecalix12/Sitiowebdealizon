...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $nombreLibro = 'El Buen Cirujano.txt'; // Nombre del archivo a descargar

        // Generar el archivo .txt
        $fileContent = "Nombre del Libro: El Buen Cirujano\n";
...
<body>
    ...
    <div class="product-container">
        <h1>El Buen Cirujano</h1>
        <img src="https://template.canva.com/EADtutwov_Q/1/0/256w-nJr37FPJeZs.jpg" alt="Imagen del Producto">
