...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $nombreLibro = 'CrucedeCaminos.txt'; // Nombre del archivo a descargar

        // Generar el archivo .txt
        $fileContent = "Nombre del Libro: Cruce de Caminos\n";
...
<body>
    ...
    <div class="product-container">
        <h1>Cruce de Caminos</h1>
        <img src="https://marketplace.canva.com/EAFutLMZJKs/1/0/1003w/canva-portada-libro-novela-suspenso-elegante-negro-wxuYB_sJtMw.jpg" alt="Imagen del Producto">
